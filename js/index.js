...
rating.innerText = el.ratingRevievs;

if(el.price.oldUan || el.price.newUan){
    newPrice.innerText = el.price.newUan;
    oldPrice.innerText = el.price.oldUan;
}
else{
    oldPrice.innerText = el.price;
    oldPrice.className='now-price';
}
